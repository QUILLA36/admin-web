...
// Ambil data pengguna
$stmt = $conn->prepare("SELECT username, email, role, phone FROM users WHERE id = ?");
...
<html lang="id">
  ...
  <body id="reportsPage">
    ...
    <h2 style="color: white">Edit Pengguna</h2>
    <form method="POST">
        <div class="mb-3">
            <label style="color: white;">Username:</label>
            <input type="text" name="username" class="form-control" style="background-color: white; color: black; border: 1px solid #ccc;" value="<?= htmlspecialchars($user['username']) ?>" required>
        </div>
        <div class="mb-3">
            <label style="color: white;">Email:</label>
            <input type="email" name="email" class="form-control" style="background-color: white; color: black; border: 1px solid #ccc;" value="<?= htmlspecialchars($user['email']) ?>" required>
        </div>
        <div class="mb-3">
    ...
    <select name="role" class="form-control" 
        ...
        <div class="mb-3">
            ...
            <input type="text" name="phone" class="form-control" style="background-color: white; color: black; border: 1px solid #ccc;" value="<?= htmlspecialchars($user['phone']) ?>" required>
        </div>
