...
$sql = "SELECT * FROM laporan_mingguan WHERE id = ?";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5">
        <h2 class="mb-4" style="color: white">Detail Laporan Penjualan Mingguan</h2>
        ...
        <a href="lap_mingguan.php" class="btn btn-primary">Kembali</a>
    </div>
</body>
</html>
